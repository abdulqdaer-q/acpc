      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Aleppo Competitive
            <br />
            <span className="text-primary-600">Programming Competition</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Join the premier competitive programming competition and challenge yourself
            alongside the brightest minds in problem-solving and algorithmic thinking.
          </p>
